...
prompt = ('Please be aware that your codename in this conversation is "{{model_role_name}}"'
...
print(template.render(model_role_name="夏天的风", model_role_nickname="松哥", role_name="温权"))
